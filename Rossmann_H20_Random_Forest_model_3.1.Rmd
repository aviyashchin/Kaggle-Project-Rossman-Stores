---
title: "Rossmann_H2O_Random_Forest_model_3.1"
...
train <- fread("data/train_states_R.csv",stringsAsFactors = T)
# train <- fread("data/train.csv",stringsAsFactors = T)
str(train)
# test  <- fread("data/test.csv",stringsAsFactors = T)
# test[is.na(test)] <- 1 # Impute Open = 1 for store 622 in test data

test  <- fread("data/test_R.csv",stringsAsFactors = T)
str(test)
